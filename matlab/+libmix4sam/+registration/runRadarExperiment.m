...
%RUNRADAREXPERIMENT Run a general radar-registration experiment in 2D.
%
%   See also GENRADARPROBLEM, OPTIMIZERADARPROBLEM.
...
if ~isempty(estimation) && ~isempty(timing), return; end
clear estimation;
...
for iLmSet = size(experiment,2):-1:1
    ...
    parfor i=1:size(experiment,1)
        ...
        estimation(i,iLmSet) = libmix4sam.registration.optimizeRadarProblem(...
            previous,...
            current,...
            init,...
            optimizerParams);        
